...
#define DEBOUNCE_COUNT 1    // This is the number of consecutive reads that must be the same before accepting a pin change
#define INTERRUPT_PERIOD 250  // This is   cpu_clock_frequency / prescaler / desired_interrupt_frequency
